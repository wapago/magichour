...
import com.example.magichour.repository.WinRepository;
...
public class WinBatch {
    ...
    public WinBatch(JobRepository jobRepository, PlatformTransactionManager platformTransactionManager, WinRepository winRepository) {
